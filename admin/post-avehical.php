...
<head>
	...
	<title>Bismillah auto car rent and buy service | Admin Post Vehicle</title>
...
<div class="form-group">
<label class="col-sm-2 control-label">Price Per Day(in BD TK)<span style="color:red">*</span></label>
<div class="col-sm-4">
