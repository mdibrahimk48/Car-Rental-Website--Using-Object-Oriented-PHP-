...
<title>Bismillah auto car rent and buy service | My Profile</title>
<!--Bootstrap -->
...
function validateForm() {
    var x = document.forms["updateForm"]["fullname"].value;
    if (x == "") {
...
<script>
function validateForm() {
    var x = document.forms["updateForm"]["mobilenumber"].value;
    if (x == "") {
          ...
          <form  method="post" name="updateForm" action="profile.php" onsubmit="return validateForm()">
           <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg" name="fullname" value="<?php echo htmlentities($result->FullName);?>" id="fullname" type="text"  >
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg" name="mobilenumber" value="<?php echo htmlentities($result->ContactNo);?>" id="phone-number" type="text">
            </div>
            <div class="form-group">
